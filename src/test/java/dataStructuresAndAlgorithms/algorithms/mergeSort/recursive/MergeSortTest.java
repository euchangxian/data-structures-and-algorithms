package dataStructuresAndAlgorithms.algorithms.mergeSort.recursive;

import org.junit.Assert;
import org.junit.Test;

import dataStructuresAndAlgorithms.algorithms.sorting.mergeSort.recursive.MergeSort;
...
public class MergeSortTest {
    ...
    public void test_insertionSort_shouldReturnSortedArray() {
        ...
        Assert.assertArrayEquals(firstResult, firstArray);
        Assert.assertArrayEquals(secondResult, secondArray);
        Assert.assertArrayEquals(thirdResult, thirdArray);
        Assert.assertArrayEquals(fourthResult, fourthArray);
        Assert.assertArrayEquals(fifthResult, fifthArray);
    }
}
