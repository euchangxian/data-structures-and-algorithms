...
import dataStructuresAndAlgorithms.algorithms.sorting.cyclicSort.simple.CyclicSort;
...
public class SimpleCyclicSort {
    ...
    public void test_cyclicSort_shouldReturnSortedArray() {
        ...
        Assert.assertArrayEquals(firstArray, firstExpected);
        Assert.assertArrayEquals(secondArray, secondExpected);
        Assert.assertArrayEquals(thirdArray, thirdExpected);
    }
}
